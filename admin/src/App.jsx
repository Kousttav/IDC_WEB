...
const API        = import.meta.env.VITE_API_URL;              // e.g. https://idc-web-ybvc.onrender.com/api
const SOCKET_URL = API.replace("/api", "");                   // e.g. https://idc-web-ybvc.onrender.com
const SITE_URL   = import.meta.env.VITE_SITE_URL || "/";     // public-facing site link
...
function LoginScreen({ onLogin }) {
  ...
  const handleLogin = async () => {
    if (!user.trim() || !pass.trim()) { setError("Please enter username and password."); return; }
